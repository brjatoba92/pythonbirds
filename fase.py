...
class Fase():
    def __init__(self, intervalo_de_colisao=1):
        ...
        self._passaros = [] #indica para o usuario que não deveria acessar diretamente o objeto
        self._porcos = []
        self._obstaculos = []
    ...
    def adicionar_obstaculo(self, *obstaculos):
        ...
        :param obstaculos:
        """
        self._obstaculos.extend(obstaculos) #adcionar os obstaculos contidos numa lista
