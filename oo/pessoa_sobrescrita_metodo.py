...
class Mulher(Pessoa):  # Herança
    estado_cidade = 'Dallas'  # Sobrescrita de atributos
    def cumprimentar(self):
        cumprimentar_da_classe = Pessoa.cumprimentar(self)
        return f'{cumprimentar_da_classe}. Aceno com a cabeça'




if __name__ == "__main__":
    rayanne = Mulher(nome='Rayanne')
    ...
    rafael = Homem(rayanne, paula, ana, sergio, paulo, gustavo, nome='Rafael')  # gustavo filho do Rafael
    ...
    print(Pessoa.nome_e_atributos_de_classe(), rayanne.nome_e_atributos_de_classe())
